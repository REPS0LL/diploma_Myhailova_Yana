...
Запустіть комірку з функцією тренування для `UNetResizeConv` (модель почне оптимізацію ваг).

# 3. Тренування модифікованої архітектури Adaptive U-Net
Запустіть комірку з функцією тренування для `AdaptiveUNet` (модель задіє блоки поканальної уваги).
